    ...
    <div>
      <center>  <form action="#" method="post">
            ...
            <tr>
                    ...
                    <tr>
                        <td>DIVISA</td>
                        <td><input type="text" name="divisa" id="" value="<?=$divisa?>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>MONEDA:</td>
                        <td><input type="text" name="moneda" id="" value="<?=$moneda?>"></td>
                    </tr>
                    <tr>
                        <td>VALOR:</td>
                        <td><input type="text" name="valor" id="" value="<?=$valor?>"></td>
                    </tr>
                    <tr>
...
<!--REALIZAMOS EL CALCULO DE NUEVO PARA PODER EDITAR.-->
<?php
                                
             if(isset($_POST['btnCalcularEditar']))
             {
                echo "<br>";
